...
${EMCPP} \
    ...
    -sUSE_PTHREADS=0 \
    -sEXPORTED_FUNCTIONS='[ duckdb_open, duckdb_connect, duckdb_disconnect, duckdb_close, duckdb_query, duckdb_value_int32, duckdb_value_varchar, duckdb_destroy_result, duckdb_prepare ]' \
    -DNDEBUG \
